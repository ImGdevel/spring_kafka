...
- Controller는 애플리케이션 인터페이스인 `MessagePublisher`만 호출한다. (인터페이스: `infra-mq/src/main/java/com/study/messaging/MessagePublisher.java`)

- Kafka로 실제 전송(Infra): `infra-mq/src/main/java/com/study/kafka/infra/kafka/KafkaMessagePublisher.java`
